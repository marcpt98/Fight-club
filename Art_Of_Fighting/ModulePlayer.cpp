...
ModulePlayer::ModulePlayer()
{
	...
	forward.PushBack({ 108, 660, 51, 103 }, 0.2, 0, -1, 0, 0);
	forward.PushBack({ 159, 660, 47, 102 }, 0.2, 0, -4, 0, 0);
	forward.PushBack({ 254, 660, 45, 103 }, 0.12, 0, 0, 0, 0);
	forward.PushBack({ 206, 660, 47, 103 }, 0.2, 0, -2, 0, 0);

	//backawrd animation                               FIXED
	backward.PushBack({ 206, 660, 47, 103 }, 0.12, 0, 0, 0, 0);
	backward.PushBack({ 254, 660, 45, 103 }, 0.12, 0, 0, 0, 0);
	backward.PushBack({ 159, 660, 47, 102 }, 0.12, 0, -3, 0, 0);
	backward.PushBack({ 108, 660, 51, 103 }, 0.12, 0, -1, 0, 0);
